...
//				+"Wage='"+uTeacher.getWage()+"' where TeacherId='"+id+"';");
		...
		case 5:
			...
			break;
		case 6:
			sql = ("update `Basic_TeachingRecord` set "+changekeyword+"= '"+changedata+"' where StudentId = '"+id+"';");
			break;
		case 7:
			sql = ("update `Basic_TeachingRecord` set "+changekeyword+"= '"+changedata+"' where TeacherId = '"+id+"';");
			break;
